...
%   d      : Leaky integratIion coefficient (e.g. 0.99)
...
if length(x)>p_vt
    ...
    intermediate = double(y.*win);
    Hvt1 = lpc(intermediate,double(p_vt));
    ...
    Hg2 = lpc(double(g1.*win),double(p_gl));
    ...
    Hvt2 = lpc(double(y.*win),double(p_vt));

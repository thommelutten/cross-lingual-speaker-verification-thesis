...
# SRE16 trials
sre16_trials=data/sparc_eval_test/trials
...
#    data/swbd2_phase1_train data/swbd2_phase2_train data/swbd2_phase3_train
  ...
  #local/make_sre16_eval.pl sre16/2016_nist_sre_test/data/eval/R149_0_1/ data
  ...
  #local/make_sre16_unlabeled.pl sre16/2016_nist_sre_test/data data
fi
...
if [ $stage -le 1 ]; then
  ...
  for name in sparc_eval_enroll sparc_eval_test; do #sre16_eval_enroll sre16_eval_test; do #sre swbd sre16_eval_enroll sre16_eval_test sre16_major; do
...
if [ $stage -le 9 ]; then
  ...
  $train_cmd exp/scores/log/sre16_eval_scoring.log \
    ...
    "ark:ivector-mean ark:data/sparc_eval_enroll/spk2utt scp:exp/xvectors_sre16_eval_enroll/xvector.scp ark:- | ivector-subtract-global-mean exp/xvectors_sre16_major/mean.vec ark:- ark:- | transform-vec exp/xvectors_sre_combined/transform.mat ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
  ...
  # For reference, here's the ivector system from .]; then
